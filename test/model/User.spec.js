...
(function(root, factory) {
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instane = new ProinApi.User();
      //expect(instance).to.be.a(ProinApi.User);
    });
    ...
    it('should have the property depName (base name: "DepName")', function() {
      // uncomment below and update the code to test the property depName
      //var instane = new ProinApi.User();
      //expect(instance).to.be();
    });
