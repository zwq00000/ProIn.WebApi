...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProinApi.PagedUsers();
  });
  ...
  describe('PagedUsers', function() {
    it('should create an instance of PagedUsers', function() {
      // uncomment below and update the code to test PagedUsers
      //var instane = new ProinApi.PagedUsers();
      //expect(instance).to.be.a(ProinApi.PagedUsers);
    });
